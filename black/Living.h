...
public:
    ...
    virtual bool ArrivesAtWoodReaction(); /* 0x8c0 */
    virtual bool InHand();
    ...
    virtual int CallIntoAnimationFunction(VILLAGER_STATES state); /* 0x8e0 */
    ...
    virtual void SetStateSpeed(); /* 0x8f0 */
    ...
    virtual ANIM_LIST GetAnimId(); /* 0x900 */
    virtual uint32_t CallExitStateFunction(VILLAGER_STATES state);
    virtual uint32_t CallEntryStateFunction__UcUc(VILLAGER_STATES state_1, VILLAGER_STATES state_2);
    ...
    virtual int ExitReaction(VILLAGER_STATES state); /* 0x910 */
    ...
    virtual int ExitInFlying(VILLAGER_STATES state); /* 0x920 */
    ...
    virtual int ExitMoveToPos(uint8_t param_1); /* 0x930 */
    ...
    virtual uint32_t EnterMoveToPos(VILLAGER_STATES state_1, VILLAGER_STATES state_2);
    // win1.41 005ed7e0 mac inlined Living::EnterInScript(VILLAGER_STATES, VILLAGER_STATES)
    virtual uint32_t EnterInScript(VILLAGER_STATES state_1, VILLAGER_STATES state_2); /* 0x940 */
    // win1.41 00417060 mac inlined Living::EnterInHand(VILLAGER_STATES, VILLAGER_STATES)
    virtual uint32_t EnterInHand(VILLAGER_STATES state_1, VILLAGER_STATES state_2);
    ...
    virtual uint32_t EnterDanceInScript(VILLAGER_STATES state_1, VILLAGER_STATES state_2);
    // win1.41 007687d0 mac inlined Living::EnterScriptWander(VILLAGER_STATES, VILLAGER_STATES)
    virtual uint32_t EnterScriptWander(VILLAGER_STATES state_1, VILLAGER_STATES state_2); /* 0x950 */
    ...
    virtual uint32_t EnterPlayAnim(VILLAGER_STATES state_1, VILLAGER_STATES state_2);
    ...
    virtual void AddReaction(Reaction* reaction, VILLAGER_STATES state); /* 0x990 */
    ...
    virtual void ResetStateAfterReacting(); /* 0x9a0 */
    ...
    virtual void SetupLookAtNiceSpell(GameThingWithPos* param_1, Reaction* param_2); /* 0x9b0 */
    ...
    virtual void SetupReactToWood(GameThingWithPos* param_1, Reaction* param_2); /* 0x9c0 */
    ...
    virtual void SetupReactToBall(GameThingWithPos* param_1, Reaction* param_2); /* 0x9d0 */
    ...
    virtual void SetupReactToHandPickUp(GameThingWithPos* param_1, Reaction* param_2); /* 0x9e0 */
    ...
    virtual void SetupReactToTeleport(GameThingWithPos* param_1, Reaction* param_2); /* 0x9f0 */
    ...
    virtual void SetupReactToFainting(GameThingWithPos* param_1, Reaction* param_2); /* 0xa00 */
    ...
    virtual void SetupReactToBreeder(GameThingWithPos* param_1, Reaction* param_2); /* 0xa10 */
    ...
    virtual void SetupReactToBurningObjectInHand(GameThingWithPos* param_1, Reaction* param_2); /* 0xa20 */
    ...
    virtual uint8_t LookAtObjectPriority(Reaction* param_1, Reaction* param_2); /* 0xa30 */
    ...
    virtual uint8_t LookAtNiceSpellPriority(Reaction* param_1, Reaction* param_2); /* 0xa40 */
    ...
    virtual uint8_t ReactToWoodPriority(Reaction* param_1, Reaction* param_2); /* 0xa50 */
    ...
    virtual uint8_t ReactToFirePriority(Reaction* param_1, Reaction* param_2); /* 0xa60 */
    ...
    virtual uint8_t ReactToHandPickUpPriority(Reaction* param_1, Reaction* param_2); /* 0xa70 */
    ...
    virtual uint8_t ReactToTeleportPriority(Reaction* param_1, Reaction* param_2); /* 0xa80 */
    ...
    virtual uint8_t ReactToFaintingPriority(Reaction* param_1, Reaction* param_2); /* 0xa90 */
    ...
    virtual uint8_t ReactToBreederPriority(Reaction* param_1, Reaction* param_2); /* 0xaa0 */
    ...
    virtual uint8_t ReactToBurningObjectInHandPriority(Reaction* param_1, Reaction* param_2); /* 0xab0 */
    ...
    virtual uint32_t StandardNumGameTurnsToReactFunction(GameThingWithPos* param_1, uint32_t param_2, float param_3); /* 0xac0 */
    ...
    virtual uint32_t NumGameTurnsToReactToPredatorFunction(GameThingWithPos* param_1, uint32_t param_2, float param_3); /* 0xad0 */
    ...
    virtual uint32_t NumGameTurnsBeforeReactingAgainToBurningObjectFunction(GameThingWithPos* param_1, uint32_t param_2, float param_3); /* 0xae0 */
    ...
    virtual void GetFleeingPositionFromStationaryObject(MapCoords* param_1, GameThingWithPos* param_2, float param_3); /* 0xb00 */
    ...
    virtual float CalculateLifeDesire(); /* 0xb10 */
    ...
    virtual bool AttackAllowedForChessGame(); /* 0xb20 */
    ...
    virtual void SetBoxXForChessGame(int param_1); /* 0xb30 */
