...
float Creature::GetFacingDirection()
{
    return 0;
}
...
uint32_t Creature::SaveObject(LHOSFile* param_1, const MapCoords* param_2)
{
    return 0;
}

// win1.41 00478c00 mac 101d8e40 Creature::FillInEffectDefenceMultiplier(EffectNumbers &)
void Creature::FillInEffectDefenceMultiplier(EffectNumbers* param_1)
{
}
...
void Creature::ApplySingleEffect(EFFECT_TYPE param_1, float param_2, GameThing* param_3, const MapCoords* param_4)
{
}
...
void Creature::ReactToPhysicsImpact(PhysicsObject* param_1, bool param_2)
{
}
...
void Creature::SetUpPhysOb(PhysOb* param_1)
{
}
...
uint32_t Creature::InterfaceValidToGiveObject(GInterfaceStatus* param_1, Object* param_2)
{
    return 0;
}

// win1.41 0047b150 mac 101d4b00 Creature::GetImpressiveIntensity(IMPRESSIVE_TYPE)
float Creature::GetImpressiveIntensity(IMPRESSIVE_TYPE param_1)
{
    return 0;
}

// win1.41 0047b160 mac 101d4a80 Creature::SetScale(float)
void Creature::SetScale(float param_1)
{
}
...
void Creature::SetControlledByScript(int param_1)
{
}
